...
def query1():
    ...
    if(result==[]):
        ...
        print("CLIENTE            |        DATA         |       RATING       |     VOTES       |")
        for x in result:
            print(str(x[6]) + "        "+ str(x[1]) + "                   " + str(x[3]) + "                 "+ str(x[2]) )
    #print(result, '\n')
...
def query6():
    print("\n\nLembrete: Algumas consultas podem demorar bastante ;D \n")
...
def query7():
    ...
    print("Cliente                  |       GRUPO        |        COMENTARIOS        |")
    print("\n")
    for x in result6:
        print(str(x[0]) + "                    " + str(x[1]) + "                   "+str(x[3]) )
    #print(result6, '\n')
